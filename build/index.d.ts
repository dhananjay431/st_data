import { DateRange, IntradayData, EquityDetails, EquityTradeInfo, EquityCorporateInfo, EquityHistoricalData, SeriesData, IndexDetails, IndexHistoricalData } from './interface';
...
export declare class NseIndia {
     ...
     * @returns
     */
    getDataByEndpoint(apiEndpoint: string, isLegacy?: boolean): Promise<any>;
    /**
     *
    ...
    getOption(index: string): Promise<IndexDetails>;
    /**
     *
     * @param index
     * @param isPreOpenData
